...
**HomePro Online:**
- [Search: "COTTO wall hung toilet"](https://www.homepro.co.th/) ← **NEED ACTUAL URL**
- [Search: "โถสุขภัณฑ์แขวนผนัง COTTO"](https://www.homepro.co.th/search?q=โถสุขภัณฑ์แขวนผนัง+COTTO) ← **NEED ACTUAL URL**

**Lazada:**
- [Search: "COTTO wall hung toilet concealed cistern"](https://www.lazada.co.th/catalog/?q=COTTO+wall+hung+toilet) ← **NEED ACTUAL URL**

**COTTO Official:**
- [COTTO Wall-Hung Toilets](https://www.cotto.com/th/products/sanitary-ware/wall-hung) ← **NEED ACTUAL URL**
- [COTTO Product Catalog](https://www.cotto.com/th/) ← **NEED ACTUAL URL**

**Photo Requirements:**
- [ ] COTTO wall-hung toilet display at HomePro (complete system)
- [ ] Price tag showing complete package price
- [ ] Cistern frame and flush plate options
- [ ] Close-up of toilet bowl (showing quality)
- **Filenames**:
  - `2.1-toilet-cotto-wall-hung-complete.jpg`
  - `2.1-toilet-cotto-price.jpg`
  - `2.1-toilet-cistern-frame.jpg`
