// Construction spec theme — Laem Chabang House
...
#let conf(
  ...
  // PDF bookmarks — enables clickable heading sidebar in PDF viewers
  set document(
  ...
  // Cover block — compact, top of page 1
  if title != none {
  ...
  // H1 — weak pagebreak prevents orphaned section headers
  ...
  // Tables — full width, no stroke, accent header
  set table(
